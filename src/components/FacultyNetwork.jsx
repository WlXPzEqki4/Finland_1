  ...
  return (
    <div className="flex flex-col w-full max-w-6xl">
      ...
      <div className="flex items-center mb-4">
        ...
        <span className="text-sm">Hover over or click on a name to see more information.</span>
      </div>
      ...
      <div className="flex">
        <div className="w-3/4 border border-gray-200 rounded-md bg-white relative overflow-auto" style={{ height: '700px' }}>
          ...
          <div className="absolute bottom-0 right-0 mr-3 mb-3">
            <div className="flex items-center text-sm py-1 px-2 bg-white border border-gray-200 rounded-md shadow-sm">
              <span>Scroll to see more</span>
              <svg viewBox="0 0 24 24" width="16" height="16" className="ml-2">
        ...
        <div className="w-1/4 ml-4">
          ...
          <div className="mt-4 border border-gray-200 rounded-md p-4 bg-white">
            ...
            <p className="text-sm mb-2">This visualization shows research collaborations between faculty members from different departments.</p>
            <p className="text-sm">The arcs represent collaborative relationships, with thicker lines indicating stronger collaborations.</p>
          </div>
        </div>
      </div>
    </div>
