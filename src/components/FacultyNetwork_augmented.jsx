  ...
  useEffect(() => {
    ...
    //   })
      ...
      const link = svg.append("g")
        ...
        // ... (rest of your link attributes remain the same)
          ...
          {selectedFaculty ? (
            <div className="flex flex-col gap-6" style={{ height: '950px' }}>
              ...
              {/* <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-700 uppercase mb-2">AFFILIATIONS</h3>
                <p className="text-gray-600 mb-6">{selectedFaculty.collaborations} total affiliations</p>
                
                <div className="mb-6">
                  <h3 className="text-xl font-semibold text-gray-700 uppercase mb-2">SECTOR</h3>
